...
const messageText = `To the queen of my heart 💗
I want to take a moment to express the depth of my feelings for you. You are the light that brightens my days, and this message is just a few lines on a screen, but it holds my entire heart reaching out to you. Your smile is a sunrise that chases away my doubts and makes everything possible.
When I think of you I feel steady, calm, and braver; your laughter is my favorite song and your kindness is a home I always want to return to.
I promise to listen, to support your dreams, and to make you laugh when you need it most. Whatever comes next, I want to face it with you by my side. Love yaa!! - Dave🌹`;

function typeMessage(text, elementId, speed = 15) {
...
document.getElementById('showMessageBtn').addEventListener('click', function() {
  ...
  typeMessage(messageText, 'message', 45);
